    ...
    return(
        <div>
            ...
            <div className="absolute w-full h-[450px]  bg-black bg-opacity-75 text-white text-center my-auto ">
                ...
                <Link to={link}><div className="flex w-fit bg-white text-black md:text-lg my-5 p-1 md:p-2 transition-transform transform hover:scale-125">Read More <span><ArrowRightIcon className="text-black mx-2 md:w-6 md:h-7 w-4 h-4 md:text-3xl items-center justify-center mr-2" /></span></div></Link>
                </div>
            </div>
